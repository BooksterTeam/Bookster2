...
import io.bookster.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("io.bookster.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("io.bookster.repository.search")
