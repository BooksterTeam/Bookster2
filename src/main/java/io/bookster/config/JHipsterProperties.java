...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "Bookster2@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "Bookster2 API";

        private String description = "Bookster2 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "Bookster2";
