(function() {
    ...
    LendingRequestDetailController.$inject = ['$scope', '$rootScope', '$stateParams', 'entity', 'LendingRequest', 'BooksterUser', 'Copy'];

    function LendingRequestDetailController($scope, $rootScope, $stateParams, entity, LendingRequest, BooksterUser, Copy) {
        var vm = this;
